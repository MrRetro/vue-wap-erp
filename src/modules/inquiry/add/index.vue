    ...
    onBtnClick() {
      ...
      Promise.all(arr).then(data => {
        ...
        if (state) {
          ...
          if (typeof items.billingDemand !== 'number' && items.billingDemand) { items.billingDemand = parseFloat(items.billingDemand); }
    ...
    selClue(obj) {
      ...
      this.form.data.forEach((item, index)=>{
        ...
        if (item.attr === 'indicativePrice') {
          this.form.data[index].text = obj.indicativePrice;
          this.form.data[index].value = obj.indicativePrice;
        }
        ...
        .then((res)=>{
          ...
          data.forEach((item)=>{
            ...
            if (edit[obj.attr]) {
              ...
              // 指导价
              if (item.attr === 'indicativePrice') {
                obj.text = edit.indicativePrice;
                obj.value = edit.indicativePrice;
              }
