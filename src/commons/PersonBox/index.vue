  ...
  <div class="person-box">
    <div v-if="form.name" class="master-box">
      ...
      <div class="master">
        ...
        <yi-touch v-if="edit && hasMaster && isLeader" class="btn-box" @click="onChangeMan">
          <span class="btn">{{hasMaster ? '转交':''}}</span>
        </yi-touch>
      </div>
...
export default {
  ...
  computed: {
    ...
    // 判断是否有master
    hasMaster() {
      return !!(this.form.master && this.form.master.name);
    },
    showParter() {
    ...
    /**
       ...
       */
    changeAuthority() {
      return this.isLeader || (this.userId === this.form.master.id);
    }
  },
  methods: {
    // 转让
